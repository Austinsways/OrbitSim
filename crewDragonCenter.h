...
/**************************************************
 * CREW DRAGON CENTER
 * The center piece of the Crew Dragon
 **************************************************/
class CrewDragonCenter : public Satellite
{
public:
	CrewDragonCenter() : Satellite() { init(); }
	CrewDragonCenter(const Position& position, const Velocity& velocity, double angle = 0.0) : Satellite(position, velocity, angle, true) { init(); }
